...
public class PlatformFullCampaign {
    private Long platform_campaign_id;
    private Integer platform_full_amount;
    ...
    public Integer getPlatform_full_amount() {
        return platform_full_amount;
    }

    public void setPlatform_full_amount(Integer platform_full_amount) {
